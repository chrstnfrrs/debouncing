...
import type { loader as booksLoader } from "./resources.v1.books";
      ...
      <div className="flex flex-col flex-1/2 gap-4">
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            onChange={(e) => {
              fetcher.load(
                `${href("/resources/v1/books")}?q=${encodeURIComponent(e.target.value)}`
              );
            }}
            onBlur={(e) => {
        ...
        {/* Has Data */}
        {fetcher.state === "idle" && !!fetcher.data?.length && (
          <ul className="list-inside list-disc">
            {fetcher.data.map((book) => (
              <li key={book.key}>
      ...
      <div className="flex flex-col gap-4 flex-1/2">
        ...
        <pre className="text-wrap">
          {JSON.stringify(
            {
              state: fetcher.state,
              data: fetcher.data?.slice(0, 2) || null,
            },
            null,
            2
          )}
